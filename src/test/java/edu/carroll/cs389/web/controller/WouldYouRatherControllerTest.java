...
//
//    @Test
//    public void testOptionsPostWithValidData() throws Exception {
//        when(questionService.addQuestion(any(Question.class))).thenReturn(new Question("Option A", "Option B"));
//
//        mockMvc.perform(post("/Entry")
