...
public class WouldYouRatherController {
    ...
    @PostMapping("/")
    public String optionsPost(@RequestParam String optionA, @RequestParam String optionB, @ModelAttribute WouldYouRatherForm wouldYouRatherForm, Model model, BindingResult result) {
        if (!result.hasErrors()){
